    ...
    <>
            ...
            <div className="grid md:grid-cols-2 gap-0">
              ...
              <div className="p-8 lg:p-12 flex flex-col justify-center">
                ...
                <p className="text-[#333]/70 text-base mb-6 leading-relaxed">
                  Wolf&apos;s Siding Inc. is owner-operated by Ezequias Lobo with experience since 2007.
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1 mt-1">
                      ...
                      <span className="text-xs text-[#333]/50 ml-1">{REVIEW_RATING} ({REVIEW_COUNT} reviews)</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className="text-center bg-gradient-to-r from-[#E00000] to-[#CC0000] rounded-3xl py-12 px-6">
        ...
        <p className="text-white/80 text-lg mb-8 max-w-xl mx-auto">
          Get a free, no-obligation estimate for your siding project. experience since 2007 across Massachusetts.
        </p>
