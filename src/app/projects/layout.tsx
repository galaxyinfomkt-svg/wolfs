...
import { SERVICES, CITIES, REVIEW_COUNT } from "../data/cities";
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <h3 className="text-center mb-6 flex items-center justify-center gap-2">
              ...
              <span className="text-[#E00000] font-bold text-sm uppercase tracking-wider">
                Service Areas &ndash; {CITIES.length}+ Cities Across Massachusetts
              </span>
            </h3>
        ...
        <div className="border-t border-white/10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="grid md:grid-cols-4 gap-10">
              <div>
                <Image src="/logo.png" alt="Wolf's Siding Inc. Logo" width={150} height={48} className="h-10 w-auto mb-4" />
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {SERVICES.filter((s) => s.slug !== "siding-repair-services").map((s) => (
                    <li key={s.slug}>
                      <Link href={`/services/${s.slug}`} className="text-white/60 hover:text-[#E00000] text-sm transition-colors">{s.shortName}</Link>
                    </li>
                  ))}
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <a href="mailto:info@wolfs-siding.com" className="text-white/70 text-sm hover:text-[#E00000] transition-colors">info@wolfs-siding.com</a>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-8 h-8 bg-[#E00000] rounded-full flex items-center justify-center flex-shrink-0">
                      <svg className="w-3.5 h-3.5 text-white" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>
