      ...
      <main>
        ...
        <section className="py-20 lg:py-28 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 scroll-animate opacity-0">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-black mb-4 leading-tight">
                Follow Us on <span className="text-[#E00000]">Instagram</span>
              </h2>
              <div className="w-20 h-1 bg-[#E00000] mx-auto mb-6 rounded-full" />
              <p className="text-[#555555] text-lg max-w-2xl mx-auto">
                See our latest projects, behind-the-scenes work, and siding transformations across Massachusetts.
              </p>
            </div>
            <div className="scroll-animate opacity-0">
              <iframe
                src="https://snapwidget.com/embed/1118475"
                className="snapwidget-widget"
                allowTransparency={true}
                frameBorder={0}
                scrolling="no"
                style={{ border: "none", overflow: "hidden", width: "100%" }}
                title="Posts from Instagram — Wolf's Siding Inc."
                loading="lazy"
              />
            </div>
