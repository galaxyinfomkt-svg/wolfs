        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-10 text-sm">
            <div className="flex items-center gap-4">
              ...
              <a href={`mailto:${BUSINESS.email}`} className="flex items-center gap-1.5 text-[11px] sm:text-sm whitespace-nowrap hover:text-white/90 transition-colors">
                <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" /></svg>
                {BUSINESS.email}
              </a>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-[70px]">
            ...
            <nav className="hidden md:flex items-center gap-6">
              <Link href="/" className="text-sm font-semibold text-[#333] hover:text-[#E00000]">Home</Link>

              {/* Services dropdown */}
              <div className="relative group">
                <button type="button" className="flex items-center gap-1 text-sm font-semibold text-[#333] hover:text-[#E00000]">
                  Services
                  ...
                  <div className="bg-white rounded-xl shadow-xl border border-gray-100 py-2 w-72">
                    {SERVICES.filter((s) => s.slug !== "siding-repair-services").map((s) => (
                      <Link
                        ...
                        className="flex items-center gap-3 px-4 py-3 hover:bg-[#E00000]/5"
                      >
              ...
              <Link href="/projects" className="text-sm font-semibold text-[#333] hover:text-[#E00000]">Projects</Link>
              <Link href="/#contact" className="text-sm font-semibold text-[#333] hover:text-[#E00000]">Contact</Link>
              <Link href="/blog" className="text-sm font-semibold text-[#333] hover:text-[#E00000]">Blog</Link>
            </nav>

            {/* Right: phone + CTA + hamburger */}
            <div className="flex items-center gap-3">
              <a href="tel:+17744841895" className="hidden sm:flex items-center gap-2 text-sm font-semibold text-[#333] hover:text-[#E00000]">
                <svg className="w-4 h-4 text-[#E00000]" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" /></svg>
                (774) 484-1895
              </a>
              <Link href="/#contact" className="hidden sm:inline-flex bg-[#E00000] hover:bg-[#CC0000] text-white px-5 py-2.5 rounded-lg text-sm font-bold hover:scale-105 transition-transform">
                Free Estimate
              </Link>
