            ...
            <div className="flex flex-wrap justify-center gap-x-1 gap-y-1 max-w-6xl mx-auto">
              {CITIES.map((c, i) => (
                <span key={c.slug} className="text-white/60 text-xs">
                  <Link href={`/${c.slug}`} className={`hover:text-[#E00000] ${c.slug === slug ? "text-[#E00000] font-semibold" : ""}`}>{c.name}</Link>
            ...
            <div className="grid md:grid-cols-4 gap-10">
              ...
              <div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <a href="tel:+17744841895" className="text-white text-sm font-semibold hover:text-[#E00000]">(774) 484-1895</a>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-8 h-8 bg-[#E00000] rounded-full flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      <a href="mailto:info@wolfs-siding.com" className="text-white/70 text-sm hover:text-[#E00000]">info@wolfs-siding.com</a>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-8 h-8 bg-[#E00000] rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <div>
                ...
                <div className="flex gap-3 mb-6">
                  <a href="https://www.facebook.com/wolfsiding" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#E00000] rounded-full flex items-center justify-center text-white hover:bg-white hover:text-[#E00000]" aria-label="Facebook">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
                  </a>
                  <a href="https://www.instagram.com/wolfs_siding_inc/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#E00000] rounded-full flex items-center justify-center text-white hover:bg-white hover:text-[#E00000]" aria-label="Instagram">
