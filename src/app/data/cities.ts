...
export const SERVICES: ServiceData[] = [
  ...
  },
  {
    ...
    material: "seamless aluminum gutters and gutter guard systems",
    description: "Protect your home's foundation, siding, and landscaping with professional gutter installation. We install seamless aluminum gutters with leaf guard systems that keep water flowing and debris out.",
    heroImage: "/services/gutter-installation.jpg",
    priceRange: "$1,500 – $8,000",
    lifespan: "20–30 years",
    idealFor: "homeowners who need reliable water management to protect their foundation, siding, and landscaping from water damage",
    painPoints: [
      "Overflowing gutters during heavy rain causing water to pool around your foundation, leading to basement leaks and structural damage over time",
      "Old, sagging, or rusted gutters that detach from the fascia board, creating gaps where water pours directly onto your siding and trim",
      "Constant clogging from leaves and debris requiring dangerous ladder climbs multiple times per year to clean out gutters by hand",
      "Ice dams forming in winter due to poor gutter drainage, causing water to back up under your roof shingles and into your home",
    ],
    benefits: [
      "Seamless aluminum gutters are custom-fabricated on-site to fit your home perfectly — no joints means no leak points",
      "Gutter guard systems eliminate the need for regular cleaning by keeping leaves, pine needles, and debris out while letting water flow freely",
      "Proper water management protects your foundation from erosion, prevents basement flooding, and extends the life of your siding and exterior paint",
      "Available in 30+ colors to match your home's exterior, with a durable baked-on finish that won't peel, chip, or fade",
      "Proper gutter sizing and downspout placement calculated for Massachusetts rainfall to handle even the heaviest storms",
      "All installations include hidden hangers for a clean look and superior strength — no exposed spikes or ferrules",
    ],
    processSteps: [
      { title: "Free Consultation", desc: "We evaluate your home's water management needs, measure your roofline, and recommend the right gutter size, style, and guard system for your property." },
      { title: "Custom Fabrication", desc: "We bring our mobile gutter machine to your home and fabricate seamless gutters on-site, cut to the exact length of each roof run — no seams, no leaks." },
      { title: "Professional Installation", desc: "Our crew installs gutters with proper slope for optimal drainage, secures them with hidden hangers, and connects downspouts to direct water away from your foundation." },
      { title: "Final Inspection", desc: "We test the entire system with water to verify proper flow, check all connections, and clean up completely — leaving your property spotless." },
    ],
    faqs: [
      { q: "How long does gutter installation take?", a: "Most residential gutter installations are completed in one day. Larger homes or complex rooflines may take two days. We fabricate the gutters on-site using our mobile gutter machine, so everything is custom-fit to your home." },
      { q: "Do I need gutter guards?", a: "If you have trees near your home, gutter guards are a smart investment. They prevent clogs from leaves and debris, eliminating the need for regular cleaning. We offer several guard styles to match different debris types and budgets." },
      { q: "What size gutters do I need?", a: "Most Massachusetts homes do well with standard 5-inch K-style gutters. Homes with large roof areas or steep pitches may benefit from 6-inch oversized gutters. We calculate the proper size based on your roof area and local rainfall data." },
    ],
    offerings: [
      "Seamless aluminum gutter installation",
      "Gutter guard and leaf protection systems",
      "Downspout installation and extensions",
      "Gutter replacement and removal",
      "Custom copper and half-round gutters",
  ...
  },
  {
    ...
    shortName: "Roofing",
    material: "asphalt shingle roofing and roof replacement",
    description: "Complete roofing installation and replacement for Massachusetts homes. We install premium asphalt shingles engineered for New England's harsh weather — protecting your home from above with expert craftsmanship.",
    heroImage: "/services/roofing-installation.jpg",
    priceRange: "$8,000 – $25,000",
    lifespan: "25–50 years",
    idealFor: "homeowners who need a new roof or full roof replacement to protect their home from New England weather",
    painPoints: [
      "Missing, cracked, or curling shingles that expose your roof deck to water infiltration, leading to leaks and interior damage",
      "Aging roof approaching end of life (20+ years) with granule loss visible in gutters and decreased weather protection year after year",
      "Water stains on ceilings or in the attic indicating active roof leaks that are causing hidden mold growth and structural damage",
      "Rising energy bills from poor roof ventilation and deteriorating underlayment that lets heat escape in winter and enter in summer",
    ],
    benefits: [
      "Premium architectural shingles provide a dimensional look with superior wind resistance (up to 130 mph) and impact protection for Massachusetts weather",
      "Complete tear-off and inspection of roof deck ensures any hidden rot, water damage, or ventilation issues are addressed before new roofing goes on",
      "Ice and water shield membrane installed along eaves, valleys, and penetrations provides critical protection against ice dams — essential for New England homes",
      "Proper ridge ventilation installed during re-roofing improves attic airflow, reduces energy costs, and extends the life of your new shingles",
      "Manufacturer warranties up to 50 years on materials, plus our workmanship guarantee — your roof is protected for decades",
      "Complete project includes new flashing around chimneys, vents, and skylights — the most common source of roof leaks",
    ],
    processSteps: [
      { title: "Free Roof Inspection", desc: "We inspect your current roof condition from the ground and attic, identify any damage or concerns, and recommend the best roofing solution for your home and budget." },
      { title: "Material Selection", desc: "Choose from premium shingle brands and colors. We help you select the right product for your home style, budget, and performance needs — with samples to see in person." },
      { title: "Detailed Proposal", desc: "Your estimate covers complete tear-off, disposal, ice and water shield, underlayment, shingles, flashing, ventilation, and cleanup — fully transparent and itemized." },
      { title: "Expert Installation", desc: "Our roofing crew strips old shingles, inspects and repairs decking, installs premium underlayment and ice protection, applies new shingles, and leaves your property immaculate." },
    ],
    faqs: [
      { q: "How long does a roof replacement take?", a: "Most residential roof replacements are completed in 2-5 days depending on the size of your home, weather conditions, and any repair work needed on the roof deck. We'll provide a specific timeline after your inspection." },
      { q: "Do I need a full replacement or just repairs?", a: "If your roof is over 20 years old, has widespread damage, or shows signs of multiple leaks, full replacement is typically the better investment. Patching an aging roof often leads to recurring issues. We'll give you an honest assessment." },
      { q: "What happens if it rains during my roof replacement?", a: "We monitor weather forecasts closely and plan our work accordingly. We always ensure your home is fully protected at the end of each workday with tarps and temporary waterproofing. Your home's interior will never be exposed to the elements." },
    ],
    offerings: [
